...
CREATE PUBLICATION postgres_master2 FOR ALL TABLES;
-- CREATE SUBSCRIPTION sub_postgres_master2 CONNECTION 'host=172.21.238.4 dbname=laravel user=replicator password=password' PUBLICATION postgres_master1;